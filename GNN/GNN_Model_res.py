...
class GNN_Model_res(nn.Module):
    def __init__(self, params):
        super(GNN_Model_res, self).__init__()
    ...
    def Formulate_Adj2(self,c_adjs2,device=None): #self,c_adjs2,c_valid,atom_list,device=None)
        ...
        study_distance = torch.exp(-(study_distance * self.dev))
        
        c_adjs2 = torch.where(c_adjs2<=1000, study_distance, filled_value)
